...
vim.keymap.set("i", "<C-Up>", "<nop>")
vim.keymap.set("i", "<C-Down>", "<nop>")
...
vim.keymap.set("i", "<C-S-Up>", "<nop>")
vim.keymap.set("i", "<C-S-Down>", "<nop>")
vim.keymap.set("i", "<C-S-Left>", "<nop>")
vim.keymap.set("i", "<C-S-Right>", "<nop>")
